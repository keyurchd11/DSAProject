...
// This is the template code for avl tree..
/* Basically we are going to implement this code to store friends(following) of "USER".

####   code consists of: 1. insertion                                           #############
                         2. removing/deleting
                         3. freeing up the entire tree (when user unregister)
                         4. for testing inorder/preorder/postorder are added.
########                                                                        ############## */
